...
class BillAdd : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAddbill.setOnClickListener {
            val title = binding.titlebill.text.toString()
            val amountString = binding.amountbill.text.toString().trim()
            val datePicker = binding.datebill
            val timePicker = binding.timebill
