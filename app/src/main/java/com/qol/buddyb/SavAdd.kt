...
class SavAdd : AppCompatActivity() {

    private lateinit var binding: ActivitySavaddBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySavaddBinding.inflate(layoutInflater)
        setContentView(binding.root)


        binding.btnCancelsav.setOnClickListener{
            super.onBackPressed()
        }

        binding.btnAddsav.setOnClickListener {
            val title = binding.titlesav.text.toString()
            val amountString = binding.amountsav.text.toString().trim()
            val datePicker = binding.datesav
            val timePicker = binding.timesav
